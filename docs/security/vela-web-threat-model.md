...
| Core integration inspector | Temporary exact GitHub archive at an immutable commit | app -> pinned Vela 0.976.1 CLI | Bounded link-free extraction; closed authority-neutral JSON; temporary bytes removed after inspection | `apps/problems/src/lib/codebase-inspection.ts`; `packages/projection-data/src/core-integration.ts` |
