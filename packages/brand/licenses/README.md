...
The following self-hosted Latin font subsets are distributed under the SIL Open
Font License 1.1:

- Inter: `inter-300-700-latin.woff2`
- Newsreader: `newsreader-200-800-latin.woff2` and
  `newsreader-200-800-italic-latin.woff2`
- IBM Plex Mono: `ibm-plex-mono-400-latin.woff2` and
  `ibm-plex-mono-500-latin.woff2`

The exact served-file hashes are recorded in `FONT-MANIFEST.sha256`. Package
