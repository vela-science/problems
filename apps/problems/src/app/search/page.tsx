...
export const metadata: Metadata = {
  title: "Search",
  description: "Search exact published Vela repository and claim projections.",
...
export default async function SearchPage() {
  ...
  return (
    <PageShell archetype="data" layout="canvas" className="flex flex-col gap-6">
      ...
      <Suspense fallback={<div role="status" aria-label="Loading search controls" className="flex flex-col gap-6"><ToolbarSkeleton controls={4} /><LedgerSkeleton rows={6} /></div>}><SearchResults projectionRoot={release.release_root} repositories={repositories.map((repository) => repository.slug)} /></Suspense>
