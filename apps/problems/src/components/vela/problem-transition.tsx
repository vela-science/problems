...
export function problemTransition(state: State): TransitionStage[] {
  ...
  const reading = problemReading({ sourceResolution: problemSourceResolution(state), currentAssertion: current?.assertion ?? null, repositoryName: state.repositoryName, retained: problemRetained(state) });
