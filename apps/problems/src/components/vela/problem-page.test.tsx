...
vi.mock("@/lib/scientific-state", () => ({
  scientificProblemState: mocks.state,
  /* The catalogue read behind the source-filed taxonomy. This suite is about
     which section renders, not about what a Problem's neighbours are. */
  problemNeighbourhood: () => Promise.resolve(null),
}));
