...
describe("Reach", () => {
  ...
  it("keeps an unreached stage visible between two reached ones", () => {
    const html = renderToStaticMarkup(<Reach stops={STOPS} endpoint="The question" caption="c" />);
  ...
  it("never fills the terminal node", () => {
    ...
    const html = renderToStaticMarkup(<Reach stops={all} endpoint="The question" caption="c" />);
  ...
  it("prints every stage as text", () => {
    const html = renderToStaticMarkup(<Reach stops={STOPS} endpoint="The question" caption="A caption." />);
