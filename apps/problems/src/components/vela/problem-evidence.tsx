...
export function ProblemEvidence({ state }: { state: State }) {
  ...
  return <>
    {claims.length ? <section aria-labelledby="other-contributions-heading">
      <div className="flex flex-wrap items-center justify-between gap-3"><h2 id="other-contributions-heading" className="text-title">Other contributions</h2><Badge variant="outline">{claims.length}</Badge></div>
