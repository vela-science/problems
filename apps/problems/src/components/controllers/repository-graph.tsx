        ...
        <div className="md:hidden">
          ...
          <Collapsible className="mt-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <CollapsibleTrigger className="flex items-center gap-2 rounded-lg border px-3 text-compact font-medium"><HugeiconsIcon icon={SlidersHorizontal} aria-hidden className="size-4" />Filters{kind !== "all" || standing || relation || trust ? <StatusBadge tone="evidence">active</StatusBadge> : null}</CollapsibleTrigger>
            </div>
